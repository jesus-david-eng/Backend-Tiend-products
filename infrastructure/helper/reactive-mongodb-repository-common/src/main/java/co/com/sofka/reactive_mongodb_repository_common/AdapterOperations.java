package co.com.sofka.reactive_mongodb_repository_common;
...
public abstract class AdapterOperations<E, D, I, R extends ReactiveCrudRepository<D, I> & ReactiveQueryByExampleExecutor<D>> {
    ...
    /*public Mono<E> findByEmailAndPassword(I email, I password) { return
    |doQuery(repository.findByEmailAndPassword(email, password)); }*/
